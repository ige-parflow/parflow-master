...
/* AXRY snow additionnal parameters */
...
void CLM_LSM(double *pressure_data, double *saturation_data, double *evap_trans_data, double *mask, double *porosity_data,
             ...
             double *clm_frac_sno_roughness_min, double *clm_frac_sno_roughness_max,
             double *clm_frac_sno_gamma_sza, double *clm_frac_sno_tau_sza,
