...
typedef struct {
  ...
  int print_initial_conditions; /* print the initial conditions, turning this off is useful during restart */
  ...
  /* Snow parameterization options @AXRY after @RMM 2025 */
  ...
  /* SZA-based snow damping parameters @AXRY after @RMM 2025 */
  ...
  /* Snow albedo parameterization options  @AXRY after @RMM 2025 */
  ...
  /* Fractional snow covered area (frac_sno) options  @AXRY after @RMM 2025 */
  ...
  /* Snow age parameterization - VIS/NIR separation  @AXRY after @RMM 2025 */
...
SetupRichards(PFModule * this_module)
{
  ...
  int print_initial_conditions = (public_xtra->print_initial_conditions); // Print the initial conditions
...
/*@LRH (JMC) add outputs*/
    ...
    {
      // If not generating initial condition files still bump filenumber using same if conditions
        ...
        switch (public_xtra->lsm)
        {
          ...
          case 1:
          {
            ...
            CALL_CLM_LSM(pp, sp, et, ms, po_dat, dz_dat, istep, cdt, t,
                        ...
                        /* @AXRY extra snow parameters after @RMM2025 */
...
SolverRichardsNewPublicXtra(char *name)
{
  ...
  /* @AXRY after @RMM 2025 Snow parameterization options */
  ...
  /*  @AXRY after @RMM 2025 SZA-based snow melt damping */
  ...
  /*  @AXRY after @RMM 2025 Snow albedo parameterization options */
  ...
  /*  @AXRY after @RMM 2025 Fractional snow covered area (frac_sno) options */
  ...
  /*  @AXRY after @RMM 2025 Snow age VIS/NIR separation parameters */
...
/* IMF Account for slope in CLM energy budget (default=False) */
  ...
  sprintf(key, "%s.PrintInitialConditions", name);
  switch_name = GetStringDefault(key, "True");
  switch_value = NA_NameToIndexExitOnError(switch_na, switch_name, key);
  public_xtra->print_initial_conditions = switch_value;
