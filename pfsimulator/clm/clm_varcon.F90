...
! saturated soil albedos for 8 color classes: 1=vis, 2=nir
  ...
  data(albsat(i,1),i=1,8)/0.126,0.135,0.10,0.09,0.08,0.07,0.06,0.05/ ! modified by TM
  data(albsat(i,2),i=1,8)/0.252,0.270,0.20,0.18,0.16,0.14,0.12,0.10/ ! modified by TM
...
! dry soil albedos for 8 color classes: 1=vis, 2=nir 
  ...
  data(albdry(i,1),i=1,8)/0.345,0.326,0.20,0.18,0.16,0.14,0.12,0.10/ ! modified by TM 0.345
  data(albdry(i,2),i=1,8)/0.69,0.652,0.40,0.36,0.32,0.28,0.24,0.20/ ! modified by TM  0.69
