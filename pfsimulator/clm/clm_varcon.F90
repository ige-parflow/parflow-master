...
! LRH (MT) modifie en remplaçant premières valeurs des deux lignes 
  ...
  data(albsat(i,1),i=1,8)/0.12,0.11,0.10,0.09,0.08,0.07,0.06,0.05/ !ARY rollback
  data(albsat(i,2),i=1,8)/0.24,0.22,0.20,0.18,0.16,0.14,0.12,0.10/ !ARY rollback
...
! LRH (MT) modifie en remplaçant premières valeurs des deux lignes 
  ...
  data(albdry(i,1),i=1,8)/0.24,0.22,0.20,0.18,0.16,0.14,0.12,0.10/ !ARY rollback
  data(albdry(i,2),i=1,8)/0.48,0.44,0.40,0.36,0.32,0.28,0.24,0.20/ !ARY rollback
