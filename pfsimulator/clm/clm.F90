...
snowage_dirt_soot_vispf,snowage_dirt_soot_nirpf,snowage_reset_factorpf) ! @AXRY after @RMM2025
  !=========================================================================
  !
...
!@LRH (JMC) end add outputs
  ...
  ! snow parameterization keys @AXRY after @RMM 2025
  ...
  ! SZA snow damping keys @AXRY after @RMM 2025
  ...
  ! snow albedo parameterization keys @AXRY after @RMM 2025
  ...
  ! frac_sno parameterization keys @AXRY after @RMM 2025
  ...
  ! snow age VIS/NIR separation keys @AXRY after @RMM 2025
   ...
   !! Loop over the tile space to assign slopes
     ...
     do t=1,drv%nch  
        ...
        if (clm(t)%planar_mask == 1) then
           ...
           ! for snow parameterization @AXRY after @RMM 2025
           ...
           ! for SZA snow damping @AXRY after @RMM 2025
           ...
           ! for snow albedo parameterization @AXRY after @RMM 2025
           ...
           ! for frac_sno parameterization @AXRY after @RMM 2025
           ...
           ! for snow age VIS/NIR separation @AXRY after @RMM 2025
