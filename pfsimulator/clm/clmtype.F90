...
! Main variables needed for restart
     ...
     real(r8) :: snowage_vis     ! VIS band snow age [-] @AXRY/@RMM 2025
     real(r8) :: snowage_nir     ! NIR band snow age [-] @AXRY/@RMM 2025
...
! SZA-based snow melt damping parameters @AXRY/@RMM 2025
...
! Snow albedo parameterization options @AXRY/@RMM 2025
...
! Fractional snow covered area (frac_sno) options @AXRY/@RMM 2025
...
! Snow age configurable parameters - VIS/NIR separation @AXRY/@RMM 2025
