...
!=== End of Variable Declaration =========================================
  ...
  do k = 1, ntiles
     ...
     clm(k)%coszen_avg         = 0.0d0 ! exponentially smoothed cos(SZA) for SZA frac_sno @AXRY after @RMM2025
     ...
     clm(k)%snowage_vis        = NaN   ! VIS band snow age [-] @AXRY/@RMM 2025
     clm(k)%snowage_nir        = NaN   ! NIR band snow age [-] @AXRY/@RMM 2025
