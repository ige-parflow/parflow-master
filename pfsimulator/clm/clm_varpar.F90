...
! define level parameters
  ...
  integer,parameter :: max_nlevsoi     =  29   !number of soil levels, should be set from input
  integer,parameter :: max_nlevlak     =  29   !number of lake levels, should be set from input
